                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-neutral-700">
                            <tr>
                                <td
                                    ...
                                    John Brown</td>
                                <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-neutral-200">45
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-neutral-200">New
                                    York No. 1 Lake Park</td>
                                <td class="px-6 py-4 text-sm font-medium whitespace-nowrap text-end">
                                    <button type="button"
                                        class="inline-flex items-center text-sm font-semibold text-blue-600 border border-transparent rounded-lg gap-x-2 hover:text-blue-800 disabled:pointer-events-none disabled:opacity-50 dark:text-blue-500 dark:hover:text-blue-400">Delete</button>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td
                                    class="px-6 py-4 text-sm font-medium text-gray-800 whitespace-nowrap dark:text-neutral-200">
                                    Jim Green</td>
                                <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-neutral-200">27
                                </td>
                            ...
                            <tr>
                                <td
                                    class="px-6 py-4 text-sm font-medium text-gray-800 whitespace-nowrap dark:text-neutral-200">
                                    Joe Black</td>
                                <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-neutral-200">31
                                </td>
                                <td class="px-6 py-4 text-sm text-gray-800 whitespace-nowrap dark:text-neutral-200">
